...
export async function middleware(request: NextRequest) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    const errorMessage =
      "CRITICAL ERROR: Your Supabase URL and Key are not configured in your hosting provider's environment variables. Please add NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY to your project settings and re-deploy.";
