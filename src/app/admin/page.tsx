              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <div className="flex gap-2 flex-wrap justify-start sm:justify-end">
                  <Button onClick={() => openConfirm(
                    ...
                    "This will DELETE all current generators and replace them with the default (PG1-PG5) generators. This cannot be undone.",
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                   <div>
                        <label className="text-slate-300 text-xs font-medium mb-1 block">Active Limit</label>
                        <Input type="number" value={newGen.active_limit || ""} onChange={e => setNewGen({ ...newGen, active_limit: parseInt(e.target.value) || 1 })} placeholder="1" className="h-9 bg-slate-700 border-slate-600 text-white text-sm focus:border-amber-500" />
                    </div>
                    <div>
                        <label className="text-slate-300 text-xs font-medium mb-1 block">Lifetime</label>
                        <Input type="number" value={newGen.lifetime_limit || ""} onChange={e => setNewGen({ ...newGen, lifetime_limit: parseInt(e.target.value) || 1 })} placeholder="5" className="h-9 bg-slate-700 border-slate-600 text-white text-sm focus:border-amber-500" />
                    </div>
                </div>
              </div>
