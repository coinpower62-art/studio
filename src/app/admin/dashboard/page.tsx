            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input type="number" value={newGen.daily_income || ""} onChange={(e) => setNewGen({ ...newGen, daily_income: parseFloat(e.target.value) || 0 })} placeholder="10" data-testid="input-gen-income" className="h-9 bg-slate-700 border-slate-600 text-white text-sm focus:border-amber-500" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                 <div>
                  ...
                  <Input type="number" value={newGen.expire_days || ""} onChange={(e) => setNewGen({ ...newGen, expire_days: parseInt(e.target.value) || 0 })} placeholder="30" data-testid="input-gen-expire" className="h-9 bg-slate-700 border-slate-600 text-white text-sm focus:border-amber-500" />
                </div>
                 <div>
